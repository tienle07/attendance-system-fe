            ...
            <div className="deadline-form">
              <div className="row g-3 mb-3">
                <div className="col-sm-6">
                  ...
                  <Select
                    ...
                    defaultValue={editModeldata ? { label: province, value: provinceEdit, type: provinceType } : null}
                ...
                <div className="col-sm-6">
                  ...
                  <Select
                    ...
                    defaultValue={editModeldata ? { label: district, value: districtEdit, type: districtType } : null}
              ...
              <div className="row g-3 mb-3">
                <div className="col-sm-6">
                  ...
                  <Select
                    options={wardlist}
                    defaultValue={editModeldata ? { label: ward, value: wardEdit, type: wardType } : null}
                    onChange={changeWard}
                  ></Select>
