...
export const LeadersListData = {
    ...
    columns: [
        ...
        //     sortable: true,
        //     render: (id) => <Link to={`/staras/member-profile/${id}`}>{id}</Link>
        // },
        {
            name: "EMPLOYEE NAME",
        ...
        },
        {
            ...
            selector: (row) => { },
            sortable: true,
            cell: row => row.active? <span className="badge bg-success">Active</span> : <span className="badge bg-danger">Inactive</span>
        },
        {
            ...
            cell: (row) => <div className="btn-group" role="group" aria-label="Basic outlined example">
                <button className="btn btn-outline-secondary" data-bs-toggle="modal" data-bs-target="#depedit" onClick={() => { }} ><i className="icofont-key-hole text-success"></i></button>
            </div>
        }
...
export const data = [
    {
        ...
        currentAddress: "215 Le Van Viet",
        profileImage: "https://firebasestorage.googleapis.com/v0/b/staras-89a8a.appspot.com/o/avatar%2F305883924_5518280591594150_2486123960045180934_n.jpg?alt=media&token=eaa10ced-1b89-49db-a438-fae0696196c5",
        level: 0,
        brandId: 2,
        citizenId: "261616161643",
        dateOfBirth: "2001-03-09T00:00:00",
        sex: "Male",
        nationality: "Viet Nam",
        placeOfOrigrin: "Binh Thuan",
        placeOfResidence: "Binh Thuan",
        dateOfIssue: "2023-11-01T00:00:00",
        issuedBy: "CA",
        active: true
    },
    {
    ...
    rows: [
        {
            ...
            image: Avatar1,
            DepartmentName: "Lô E2a-7, Đường D1, Đ. D1, Long Thạnh Mỹ, Thành Phố Thủ Đức, Thành phố Hồ Chí Minh 700000",
            employeeNo: 40
